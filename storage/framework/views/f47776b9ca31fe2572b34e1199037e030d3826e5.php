    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(menuActive('about')); ?>" href="<?php echo e(route('about')); ?>"><?php echo app('translator')->get('Special Offers'); ?></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(menuActive('contact')); ?>" href="#"><div id="liveClock" class="text-light"></div></a>
                    ...
                    <div >
                        <div >
                            ...
                            <span class="text-danger passwordError"></span>&nbsp&nbsp&nbsp</td>
                                    <td><button type="submit" class="btn-custom w-100" style="paddng: 5px">&nbsp&nbsp <?php echo app('translator')->get('sign in'); ?> &nbsp&nbsp</button></td>
...
<!-- ... your existing code ... -->
<?php /**PATH /home/centur69/majesticsport.centurybreakcap.com/resources/views/themes/betting/partials/nav.blade.php ENDPATH**/ ?>