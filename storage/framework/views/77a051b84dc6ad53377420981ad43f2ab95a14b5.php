...
<div v-if="showType == 'live'"  v-for="(item, index) in allSports_filter" class="table-parent table-responsive d-sm-block d-none">
    ...
    <table class="table table-striped">
        ...
        <tbody>
        <tr>
           <td class="text-center" style="width:5%">{{ item.start_datetime }}
            </td>
...
<div class="d-flex justify-content-evenly">
    <span><?php echo app('translator')->get('1'); ?></span>
    <span v-if="question.name.toLowerCase().trim() === 'overs run.'">X</span>
...
<!-- Past match table -->
<div  v-if="showType == 'past'"  v-for="(item, index) in past_filter" class="table-parent table-responsive d-sm-block d-none">
    <table class="table table-striped">
        <thead>
        <tr>
            <th class="text-center">
...
</div><?php /**PATH /home/centur69/majesticsport.centurybreakcap.com/resources/views/themes/betting/partials/home/content.blade.php ENDPATH**/ ?>