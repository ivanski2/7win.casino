    ...
    <div class="row g-3">
        ...
        <div class="col-lg-1 col-6 col-sm-4 col-md-3">
                ...
                <div
                    ...
                    >
                    <div class="img-box">
                      <a href="https://affbox.centurybreakcap.com/payout">  <img
                            class="img-fluid"
                            src="https://www.paymentscardsandmobile.com/wp-content/uploads/2018/07/Visa-Mastercard-1.jpg"
                            alt="<?php echo e($gateway->name); ?>"
                        /></a>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/centur69/majesticsport.centurybreakcap.com/resources/views/themes/betting/user/addFund.blade.php ENDPATH**/ ?>